...
Video Link - https://youtu.be/krmRhmQITx8?si=s3DtmsW2x7d-EiEw


You will need to download the python script and the png image of Karel to play locally. The game if played in an IDE, opens a graphic window and then the controls can be clicked to move Karel. The portals, energies, traps and the key are randomized and sometimes get placed weirdly. The levels go up in difficulty, in the sense that the allowed moves decrease and sometimes you will have to figure out a way to get to the key quickly.
